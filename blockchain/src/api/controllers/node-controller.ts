...
// Returns all vehicles owned by owner as latest transactions
...
// Creates a new vehicle transaction from input
...
// Transfers a vehicle from sender to recipient if vehicle is owned by sender
